...
public class GenCodeRunner {
    ...
    public void run(){
        ...
        genCodeConfiguration.registerCommand(new ComposeControllerEntityCommand());
        ...
        Console.log("\n");
        Console.log("开始生成....");
        genCode.genCode(tableName,command,output);
        Console.log("生成完成....");
...
//        Console.log("04-Vo");
        ...
        for(Command command : commands){
            Console.log("{}-{}",command.getCode(),command.getName());
        }
...
//        Console.log("02-File");
        ...
        List<CodeOutput> codeOutputs = CollectionUtil.newArrayList(genCodeConfiguration.getCodeOutputs());
        for(CodeOutput output : codeOutputs){
            Console.log("{}-{}",output.getCode(),output.getName());
        }
